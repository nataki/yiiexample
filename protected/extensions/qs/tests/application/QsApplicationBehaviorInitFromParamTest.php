...
/**
 * Test case for the extension "ext.qs.lib.application.QsApplicationBehaviorInitFromParam".
...
class QsApplicationBehaviorInitFromParamTest extends CTestCase {
	...
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.application.QsApplicationBehaviorInitFromParam');
