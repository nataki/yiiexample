...
/**
 * Test case for the extension "ext.qs.lib.web.auth.oauth.signature.QsOAuthSignatureMethodRsaSha1".
 * @see QsOAuthSignatureMethodRsaSha1
 */
class QsOAuthSignatureMethodRsaSha1Test extends CTestCase {
	/**
...
-----END RSA PRIVATE KEY-----';
	...
	public function testGenerateSignature() {
		$signatureMethod = new QsOAuthSignatureMethodRsaSha1();
