...
Yii::import('ext.qs.lib.web.auth.external.widgets.QsAuthExternalPopupWindowRedirect');

/**
 * Test case for the extension "ext.qs.lib.web.auth.external.widgets.QsAuthExternalPopupWindowRedirect".
