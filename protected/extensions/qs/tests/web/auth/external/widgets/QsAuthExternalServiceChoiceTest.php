...
Yii::import('ext.qs.lib.web.auth.external.widgets.QsAuthExternalServiceChoice');
Yii::import('ext.qs.lib.web.auth.external.*');

/**
 * Test case for the extension "ext.qs.lib.web.auth.external.widgets.QsAuthExternalServiceChoice".
