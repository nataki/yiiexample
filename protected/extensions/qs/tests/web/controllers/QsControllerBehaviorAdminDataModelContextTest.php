...
/**
 * Test case for the extension "ext.qs.lib.web.controllers.QsControllerBehaviorAdminDataModelContext".
...
class QsControllerBehaviorAdminDataModelContextTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.web.controllers.QsControllerBehaviorAdminDataModelContext');
