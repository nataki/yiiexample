...
/**
 * Test case for the extension "ext.qs.lib.web.controllers.filters.QsFilterGetParamRequired".
 * @see QsFilterGetParamRequired
 */
class QsFilterGetParamRequiredTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.web.controllers.filters.QsFilterGetParamRequired');
	}
