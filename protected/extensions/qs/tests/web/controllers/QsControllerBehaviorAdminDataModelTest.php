...
/**
 * Test case for the extension "ext.qs.lib.web.controllers.QsControllerBehaviorAdminDataModel".
 * @see QsControllerBehaviorAdminDataModel
 */
class QsControllerBehaviorAdminDataModelTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.web.controllers.QsControllerBehaviorAdminDataModel');
