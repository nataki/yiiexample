...
/**
 * Test case for the extension "ext.qs.lib.web.controllers.actions.QsActionAdminCallModelMethod".
...
class QsActionAdminCallModelMethodTest extends CTestCase {
	...
	public function testRedirect() {
		...
		$action->setModelMethodName('validate');
		$action->setView('');
	...
	public function testFlashMessage() {
		...
		$action->setFlashMessageKey($testFlashMessageKey);
		$testFlashMessageContent = 'Test flash message content';
		$action->setFlashMessage($testFlashMessageContent);
