...
/**
 * Test case for the extension "ext.qs.lib.console.commands.QsConsoleCommandInitApplication".
 * @see QsConsoleCommandInitApplication
 */
class QsConsoleCommandInitApplicationTest extends CTestCase {
	protected static $_logComponentBackup = null;

	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.console.commands.QsConsoleCommandInitApplication');
	...
	public function testActionLocalFileDefaultPlaceholderValues() {
		...
		$testLocalFilePlaceholderDefaultValues = array(
			$testPlaceholderName => $testPlaceholderValue
		);
		$consoleCommand->setLocalFilePlaceholderDefaultValues($testLocalFilePlaceholderDefaultValues);
