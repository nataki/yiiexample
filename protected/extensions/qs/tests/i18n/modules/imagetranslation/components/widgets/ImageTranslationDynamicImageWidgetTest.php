...
/**
 * Test case for the {@link ImageTranslationDynamicImageWidget} widget of the module "ext.qs.lib.i18n.modules.imagetranslation.ImagetranslationModule".
...
class ImageTranslationDynamicImageWidgetTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.i18n.modules.imagetranslation.ImagetranslationModule');
		Yii::import('ext.qs.lib.i18n.modules.imagetranslation.components.widgets.*');
		Yii::import('ext.qs.lib.i18n.modules.imagetranslation.models.*');
	}
