...
/**
 * Test case for the extension "ext.qs.lib.test.modules.phpunit.components.PhpUnitConfigManager".
 * @see PhpUnitConfigManager
 */
class PhpUnitConfigManagerTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.test.modules.phpunit.components.PhpUnitConfigManager');
