...
/**
 * Test case for the extension "ext.qs.lib.test.modules.phpunit.components.PhpUnitConsoleCommandManager".
 * @see PhpUnitConsoleCommandManager
 */
class PhpUnitConsoleCommandManagerTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.test.modules.phpunit.components.PhpUnitConsoleCommandManager');
	}
