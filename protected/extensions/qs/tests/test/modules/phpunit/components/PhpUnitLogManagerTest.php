...
/**
 * Test case for the extension "ext.qs.lib.test.modules.phpunit.components.PhpUnitLogManager".
 * @see PhpUnitLogManager
 */
class PhpUnitLogManagerTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.test.modules.phpunit.components.PhpUnitLogManager');
