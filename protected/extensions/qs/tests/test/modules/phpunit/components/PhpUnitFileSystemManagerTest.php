...
/**
 * Test case for the extension "ext.qs.lib.test.modules.phpunit.components.PhpUnitFileSystemManager".
 * @see PhpUnitFileSystemManager
 */
class PhpUnitFileSystemManagerTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.test.modules.phpunit.components.PhpUnitFileSystemManager');
		Yii::import('ext.qs.lib.test.modules.phpunit.models.PhpUnitFileSystemUnit');
