...
/**
 * Test case for the extension "ext.qs.lib.test.modules.phpunit.components.PhpUnitSelector".
 * @see PhpUnitSelector
 */
class PhpUnitSelectorTest extends CTestCase {
	public static function setUpBeforeClass() {
		Yii::import('ext.qs.lib.test.modules.phpunit.components.PhpUnitSelector');
		Yii::import('ext.qs.lib.test.modules.phpunit.models.*');
	}
