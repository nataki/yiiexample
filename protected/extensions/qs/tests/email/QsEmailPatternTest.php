...
/**
 * Test case for the extension "ext.qs.lib.email.includes.QsEmailPattern".
 * @see QsEmailPattern
 */
class QsEmailPatternTest extends CTestCase {
	...
	public function testSetGet() {
		...
		$this->assertEquals( $emailPattern->getSubject(), $testSubject, 'Unable to set subject corretly!' );
