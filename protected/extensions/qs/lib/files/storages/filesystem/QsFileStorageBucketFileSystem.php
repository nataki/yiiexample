<?php
/**
 * QsFileStorageBucketFileSystem class file.
 *
...
/** 
 * QsFileStorageBucketFileSystem introduces the file storage bucket based simply
 ...
 */
class QsFileStorageBucketFileSystem extends QsFileStorageBucketSubDirTemplate {
	/**
