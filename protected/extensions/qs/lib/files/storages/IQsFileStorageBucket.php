<?php
/**
 * IQsFileStorageBucket interface file.
 *
...
/** 
 * IQsFileStorageBucket is an interface for the all file storage buckets.
 * All buckets should be controlled by the instance of {@link IQsFileStorage}.
 *
 * @author Paul Klimov <pklimov@quartsoft.com>
 * @package qs.files.storages
 */
interface IQsFileStorageBucket {
	/**
	 * Sets bucket name.
