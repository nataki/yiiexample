...
class QsActiveRecordBehaviorPosition extends CBehavior {
	...
	public function movePrev() {
		...
		if (empty($previousRecord)) return false;
	...
	public function moveNext() {
		...
		if (empty($nextRecord)) return false;
	...
	public function moveFirst() {
		$owner = $this->getOwner();
		$positionAttributeName = $this->getPositionAttributeName();
		if ( $owner->getAttribute($positionAttributeName) == 1 ) return false;
	...
	public function moveLast() {
		...
		if ( $owner->getAttribute($positionAttributeName) == $recordsCount ) return false;
	...
	public function moveToPosition($position) {
		if ( !is_numeric($position) || $position<1 ) return false;
		$owner = $this->getOwner();
		$positionAttributeName = $this->getPositionAttributeName();
		...
		if ($oldRecordPosition==$position) return true;
